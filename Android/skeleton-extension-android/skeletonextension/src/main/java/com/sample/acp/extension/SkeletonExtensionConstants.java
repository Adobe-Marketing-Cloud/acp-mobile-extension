...
class SkeletonExtensionConstants {
    static final String EVENT_TYPE_SKELETON_EXTENSION = "com.sample.acp.eventType.skeletonExtension";
    static final String EVENT_SOURCE_SKELETON_REQUEST_CONTENT = "com.sample.acp.eventSource.requestContent";
    static final String EVENT_SOURCE_SKELETON_RESPONSE_CONTENT = "com.sample.acp.eventSource.responseContent";
